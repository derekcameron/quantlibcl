...
/*! \file mcsimulationocl.hpp
    \brief framework for Monte Carlo simulation on OpenCL hardware
*/

#ifndef quantlib_montecarlo_simulation_cl_hpp
#define quantlib_montecarlo_simulation_cl_hpp
...
namespace QuantLib {
    ...
    //! base class for Monte Carlo simulation on OpenCL hardware
    ...
    */
    ...
    class McSimulationCl {
      ...
      protected:
        McSimulationCl(bool antitheticVariate,
                     bool controlVariate)
    ...
    inline typename McSimulationCl<MC,RNG,S>::result_type
        McSimulationCl<MC,RNG,S>::value(Real tolerance,
                                              Size maxSamples,
    ...
    template <template <class> class MC, class RNG, class S>
    inline typename McSimulationCl<MC,RNG,S>::result_type
        McSimulationCl<MC,RNG,S>::valueWithSamples(Size samples) const {
    ...
    template <template <class> class MC, class RNG, class S>
    inline void McSimulationCl<MC,RNG,S>::calculate(Real requiredTolerance,
                                                  Size requiredSamples,
                                                  Size maxSamples) const {
    ...
    template <template <class> class MC, class RNG, class S>
    inline typename McSimulationCl<MC,RNG,S>::result_type
        McSimulationCl<MC,RNG,S>::errorEstimate() const {
        return mcModel_->sampleAccumulator().errorEstimate();
    }

    template <template <class> class MC, class RNG, class S>
    inline const typename McSimulationCl<MC,RNG,S>::stats_type&
    McSimulationCl<MC,RNG,S>::sampleAccumulator() const {
